...
def parse_arguments():
    ...
    parser.add_argument(
        "-l", "--label_dir",
        default="C://Users/Billi/repos/Computer_Vision/OpenCV/bdd100k/seg/dataimages/labels/",
        help="root directory of BDD label Json files",
    )
    parser.add_argument(
        "-s", "--save_path",
        default="C://Users/Billi/repos/Computer_Vision/",
        help="path to save formatted label file",
    )
...
if __name__ == '__main__':
    ...
    bdd2coco_detection(attr_id, train_labels, out_fn)
