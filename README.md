...
## Model
A MobileNet model pre-trained on COCO dataset with an SSD detector was used for inference using OpenCV and Caffe libraries. Some other models are also under production that are aiming to lower the inference time even further.
